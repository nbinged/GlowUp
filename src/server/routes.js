...
module.exports = (app, db) => {
  ...
  //Users Routes//
  ////////////////
  const usersControllerCallbacks = require('./controllers/users')(db);
  ...
  // //Journals Routes//
  // ///////////////////
  // const journalsControllerCallbacks = require('./controllers/journals')(db);
  //
  ...
  // //Statistics Routes//
  // /////////////////////
  // const statisticsControllerCallBacks = require('./controllers/statistics')(db);
  //
  // app.get('/statistics', statisticsControllerCallBacks.viewStatistics);
  //
  //
  // //OLD PRODUCT CONTROLLER
